...
SMBIOS_TABLE_TYPE0 mBIOSInfoType0 = {
  ...
  0,   // BiosSize
  {
    ...
    0, // PrintScreenIsSupported
    0, // Keyboard8042IsSupported
    1, // SerialIsSupported
...
CHAR8 *mBIOSInfoType0Strings[] = {
  "Xiaomi", // Vendor String
  "Redmi Note 11 Pro 5G", // BiosVersion String
...
CHAR8 *mSysInfoType1Strings[] = {
  ...
  "11 Pro 5G",
  "2201116SG",
  "Redmi Note 11 Pro 5G_veux",
  "Snapdragon 695 Device",
  NULL
};
