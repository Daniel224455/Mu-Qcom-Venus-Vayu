##
# Script to Build Google Pixel 3a UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("sargoPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('sargo', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "sargo", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "sargoPkg/sargo.dsc", "Platform Hardcoded")
