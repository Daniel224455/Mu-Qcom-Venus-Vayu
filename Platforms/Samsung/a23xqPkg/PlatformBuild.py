...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("a23xqPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('a23xq', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "a23xq", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "a23xqPkg/a23xq.dsc", "Platform Hardcoded")
